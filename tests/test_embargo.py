...
def test_walkforward_embargo_shortens_train():
    n = 150
    cv_no = WalkForwardCV(train_size=60, test_size=15, step_size=15, expanding=True, embargo=0)
    cv_em = WalkForwardCV(train_size=60, test_size=15, step_size=15, expanding=True, embargo=5)
